...
% \newcommand\shorttitle{Evidential Calibration of Confidence Intervals} % if longtitle too long, change here
% \newcommand\subtitle{}
% \newcommand\longauthors{~}
% \newcommand\shortauthors{~} % if longauthors too long, change here
% \newcommand\affiliation{
%   ~ \\
%   ~ \\
%   ~
...
\url{https://github.com/SamCH93/ECoCI}.
A snapshot of the GitHub repository at
...
% \url{https://github.com/XXXX}.
The following code snippet illustrates the computation and plotting of support
