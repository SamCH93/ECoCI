...
\begin{center}
  \begin{minipage}{14cm} {\small
      ...
      {\centering \textbf{Abstract} \\
        ...
        mapping with confidence intervals.
        % For the class of all alternatives,
        ...
        % better reflect the available evidence.
        ...
        a clinical trial illustrates how the calibration to support intervals
        can lead to inferences that are both intuitive and informative.}
      \rule{\textwidth}{0.4pt} \\
